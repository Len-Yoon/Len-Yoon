<div align="center">
  <img src="https://github.com/user-attachments/assets/b73ce838-f9e9-4c2e-bfdb-c38670fb58dd" alt="Profile Banner" />
</div>
...
- 120대 이상 서버의 상태를 대시보드에서 통합 확인할 수 있도록 구성하여, 담당자의 개별 서버 접속 기반 수동 점검 업무를 자동화
...
- 대시보드 기반 통합 가시화가 운영 담당자의 점검 효율과 장애 인지 속도를 높이는 데 중요함을 경험함
...
<details>
<summary><b>고양시 도시계획정보체계(UPIS) DB 구축 (2024.05 ~ 2024.07)</b></summary>
...
- 기존 데이터 구조를 분석한 뒤 표준 데이터 구조로 재구성할 때, 데이터 항목별 매핑 기준과 검증 규칙을 명확히 정의하는 중요성을 경험함
- 데이터 이관·정비 과정에서는 구조 변경뿐 아니라 데이터 정합성을 지속적으로 확인하는 검증 절차가 필요함을 학습함
...
<details>
<summary><b>영덕군 비표준 구전자문서 포맷변환 사업 (2024.03 ~ 2024.05)</b></summary>
...
- 포맷과 구조가 다른 비정형 전자문서를 다룰 때, 정상 흐름뿐 아니라 변환 오류와 예외 상황을 고려한 처리 기준이 필요함을 경험함
- 시스템 간 자동 이관 기능은 API 연계 자체뿐 아니라 요청·처리 상태·결과를 추적할 수 있는 모니터링 설계가 중요함을 학습함
...
<details>
<summary><b>사용자 권한 레벨에 따른 Admin 접근 및 관리 체계 구축 (2022.07 ~ 2022.08)</b></summary>
...
<details>
<summary><b>부산항만공사 프로젝트 (2021.07 ~ 2021.09)</b></summary>
